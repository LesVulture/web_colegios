...
- [x] **FOUND-02**: Modelo de datos TypeScript para telas (nombre, base, composición, tejido, peso, ancho, tecnologías, rutas), categorías (nombre, slug, color, descripción), y tecnologías (nombre, icono, descripción)
