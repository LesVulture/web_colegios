...
export const metadata: Metadata = {
  title: 'Tecnologias Textiles - Lafayette Uni For Me',
  description:
    'Conoce las 14 tecnologias textiles de Lafayette para uniformes escolares: proteccion solar, impermeabilidad, antibacterial, sostenibilidad y mas.',
}
...
export default function TecnologiasPage() {
  return (
    <div className="mx-auto max-w-7xl px-4 lg:px-8 py-6 lg:py-10">
      <Breadcrumb
        items={[{ label: 'Inicio', href: '/' }, { label: 'Tecnologias' }]}
      />

      <header className="mt-6 mb-10">
        <h1 className="text-3xl lg:text-4xl font-heading font-semibold text-foreground">
          Tecnologias Textiles
        </h1>
        <p className="text-muted-foreground mt-3 max-w-2xl">
          Cada tela Lafayette incorpora tecnologias especializadas que garantizan
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {TECHNOLOGIES.map((tech, i) => {
          ...
          return (
            <article
              key={tech.id}
              className="rounded-lg border border-border bg-background p-6 transition-all duration-300 hover:shadow-lg hover:-translate-y-1 animate-fade-in-up"
